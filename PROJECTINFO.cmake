...
SET( PLUGINNAME		"mga-ncurses" )		# define the your plugin's name, e.g. {gtk, ncurses-pkg, qt-graph}
SET( LIB_DEPS		Curses6 )		# define the plugin's dependecies CMake should look for separated with spaces; libyui-internal deps go in the next line
SET( INTERNAL_DEPS	Libyui Libyui-ncurses Libyui-mga)	# include libyui or it's plugins (if needed), too!
SET( LIB_LINKER		yui-mga yui-ncurses )	# define the libs to link against with their -l name for separated with spaces, e.g. pthread dl; include libyui or it's plugins (if needed), too!
...
SET( SUMMARY            "Libyui - Mageia extension ncurses User Interface" )
SET( DESCRIPTION        "This package contains the ncurses user interface\ncomponent for libYUI Mageia extension.\n" )
